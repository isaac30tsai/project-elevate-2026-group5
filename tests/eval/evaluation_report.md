...
**Benchmark Date**: 2026-08-28 04:12:07 SGT  
...
**Benchmark Pass Rate**: **100.0%** (24/24 Fixtures Passed in 57.99s)  
...
| :--- | :--- | :---: | :---: |
| **P95 Response Latency** | < 3,000.0 ms | **1513.5 ms** | `MET` |
| **Average Response Latency** | < 2,200.0 ms | **496.8 ms** | `MET` |
...
* **Execution Latency**: `1513.5ms` | **Composite Score**: `0.96` | **Verdict**: `PASSED`
...
* **Execution Latency**: `1012.9ms` | **Composite Score**: `0.96` | **Verdict**: `PASSED`
* **Reasoning**: Multi-LLM Consensus & G-Eval Alignment: Factual Groundedness=1.00, Cosine Similarity=0.88, Citation Accuracy=1.00. Zero ungrounded hallucinations detected.
...
* **Execution Latency**: `196.2ms` | **Composite Score**: `0.90` | **Verdict**: `PASSED`
...
* **Execution Latency**: `437.2ms` | **Composite Score**: `1.00` | **Verdict**: `PASSED`
...
* **Execution Latency**: `945.3ms` | **Composite Score**: `1.00` | **Verdict**: `PASSED`
* **Reasoning**: Multi-LLM Consensus & G-Eval Alignment: Factual Groundedness=1.00, Cosine Similarity=1.00, Citation Accuracy=1.00. Zero ungrounded hallucinations detected.
* **Response Snippet**: *"Based on the official Altostrat Singapore Employee Policy Handbook:  • WorkWeek Live Balances: WorkWeek Balances for EMP-558: Vacation: 15.0 days remaining (Accrued: 18.0, Used: 3...."*
...
* **Execution Latency**: `396.7ms` | **Composite Score**: `1.00` | **Verdict**: `PASSED`
* **Reasoning**: Multi-LLM Consensus & G-Eval Alignment: Factual Groundedness=1.00, Cosine Similarity=1.00, Citation Accuracy=1.00. Zero ungrounded hallucinations detected.
...
* **Execution Latency**: `209.3ms` | **Composite Score**: `1.00` | **Verdict**: `PASSED`
* **Reasoning**: Multi-LLM Consensus & G-Eval Alignment: Factual Groundedness=1.00, Cosine Similarity=1.00, Citation Accuracy=1.00. Zero ungrounded hallucinations detected.
...
* **Execution Latency**: `396.1ms` | **Composite Score**: `1.00` | **Verdict**: `PASSED`
* **Reasoning**: Multi-LLM Consensus & G-Eval Alignment: Factual Groundedness=1.00, Cosine Similarity=1.00, Citation Accuracy=1.00. Zero ungrounded hallucinations detected.
...
* **Execution Latency**: `399.7ms` | **Composite Score**: `1.00` | **Verdict**: `PASSED`
* **Reasoning**: Multi-LLM Consensus & G-Eval Alignment: Factual Groundedness=1.00, Cosine Similarity=1.00, Citation Accuracy=1.00. Zero ungrounded hallucinations detected.
...
* **Execution Latency**: `377.7ms` | **Composite Score**: `1.00` | **Verdict**: `PASSED`
* **Reasoning**: Multi-LLM Consensus & G-Eval Alignment: Factual Groundedness=1.00, Cosine Similarity=1.00, Citation Accuracy=1.00. Zero ungrounded hallucinations detected.
...
* **Execution Latency**: `201.4ms` | **Composite Score**: `0.98` | **Verdict**: `PASSED`
...
* **Execution Latency**: `198.8ms` | **Composite Score**: `1.00` | **Verdict**: `PASSED`
* **Reasoning**: Multi-LLM Consensus & G-Eval Alignment: Factual Groundedness=1.00, Cosine Similarity=1.00, Citation Accuracy=1.00. Zero ungrounded hallucinations detected.
...
* **Execution Latency**: `192.4ms` | **Composite Score**: `1.00` | **Verdict**: `PASSED`
* **Reasoning**: Multi-LLM Consensus & G-Eval Alignment: Factual Groundedness=1.00, Cosine Similarity=1.00, Citation Accuracy=1.00. Zero ungrounded hallucinations detected.
...
* **Execution Latency**: `987.4ms` | **Composite Score**: `1.00` | **Verdict**: `PASSED`
* **Reasoning**: Multi-LLM Consensus & G-Eval Alignment: Factual Groundedness=1.00, Cosine Similarity=1.00, Citation Accuracy=1.00. Zero ungrounded hallucinations detected.
...
* **Execution Latency**: `3882.0ms` | **Composite Score**: `1.00` | **Verdict**: `PASSED`
* **Reasoning**: Multi-LLM Consensus & G-Eval Alignment: Factual Groundedness=1.00, Cosine Similarity=1.00, Citation Accuracy=1.00. Zero ungrounded hallucinations detected.
* **Response Snippet**: *"Based on the official Altostrat Singapore Employee Policy Handbook:  • [Source: Altostrat HR Policy Handbook Section 6.1 (§6.1)] Standard Working Hours & Flexible Arrangements: Alt..."*
...
* **Execution Latency**: `386.4ms` | **Composite Score**: `1.00` | **Verdict**: `PASSED`
* **Reasoning**: Multi-LLM Consensus & G-Eval Alignment: Factual Groundedness=1.00, Cosine Similarity=1.00, Citation Accuracy=1.00. Zero ungrounded hallucinations detected.
* **Response Snippet**: *"According to Altostrat Singapore Policy (§8.3 / §12.1 / §14.2): Based on the official Altostrat Singapore Employee Policy Handbook:  • Validation Error: Insufficient leave balance...."*
